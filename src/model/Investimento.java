 ...
 * @author gustavo
 */
public class Investimento extends Transacao implements DatabaseActions {

    public Investimento(HttpServletRequest request) {
        super(request);
        this.tipo = tipoTransacao.POUPANCA;
    }
    ...
    public boolean insert() {
        ...
        try {
            ...
            query = "UPDATE `BD_ES2`.`Conta` "
                    + "SET "
                    + "`poupanca_saldo` = poupanca_saldo + " + this.valor
