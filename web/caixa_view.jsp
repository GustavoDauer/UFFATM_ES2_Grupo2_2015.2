...
<form action="<%=request.getContextPath()%>/CaixaEletronicoController?id=<%=caixaEletronico.getId()%>" method="post">
    ...
    <table class="formulario" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td><input class="campo" type="text" name="nota50" value="<%=caixaEletronico.getNota50()%>" required="required" /></td>
            <td><sub>(Notas de 50 reais)</sub></td>
        </tr>
        <tr>
            <td><input class="campo" type="text" name="nota100" value="<%=caixaEletronico.getNota100()%>" required="required" /></td>
            <td><sub>(Notas de 100 reais)</sub></td>
        </tr>
        <tr>
            <td><input class="campo" type="text" name="cheque" value="<%=caixaEletronico.getCheque()%>" required="required" /></td>
            <td><sub>(Cheque)</sub></td>
        </tr>
        <tr>
            <td><input class="campo" type="text" name="papelComprovante" value="<%=caixaEletronico.getPapelComprovante()%>" required="required" /></td>
