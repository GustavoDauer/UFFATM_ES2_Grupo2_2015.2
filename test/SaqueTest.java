 ...
 * @author Igor
 */
public class SaqueTest extends Mockito {
    ...
    @Test
    public void saqueInsuficienteLimite() {
        when(request.getParameter("valor")).thenReturn("5000");
        saque = new Saque(request);

        assertEquals(false, saque.insert());
    }

    @Test
    public void saqueSuficienteLimite() {
    ...
    @Test
    public void saqueInsuficienteNotas() {
        when(request.getParameter("valor")).thenReturn("400");
        saque = new Saque(request);
    ...
    @Test
    public void saqueSuficienteNotas() {
        when(request.getParameter("valor")).thenReturn("100");
        saque = new Saque(request);

        assertEquals(true, saque.insert());
    }
